...
var partyGRPCErrorMapper = grpcx.New(
	[]error{
		...
		domain.ErrInvalidPoll,
		domain.ErrInvalidPollOption,
		domain.ErrPollAlreadyResolved,
	...
	map[error]grpcx.ErrResponse{
		...
		domain.ErrInvalidAction:          {Code: codes.InvalidArgument, Message: "invalid room action"},
		...
		domain.ErrInvalidPoll:            {Code: codes.InvalidArgument, Message: "invalid poll"},
		domain.ErrInvalidPollOption:      {Code: codes.InvalidArgument, Message: "invalid poll option"},
		domain.ErrPollAlreadyResolved:    {Code: codes.FailedPrecondition, Message: "poll already resolved"},
...
func mapError(err error) error {
	if subscriptionGRPCErr, ok := capabilityerr.ToGRPCError(err); ok {
		return subscriptionGRPCErr
	}
