...
func (u *AuthUsecase) SearchUsersByEmail(
	ctx context.Context,
	userID int64,
	emailQuery string,
...
func (u *AuthUsecase) AddFriend(ctx context.Context, userID int64, friendID int64) (domain.FriendResponse, error) {
	if _, err := u.userRepo.GetUserByID(ctx, userID); err != nil {
...
func (u *AuthUsecase) DeleteFriend(ctx context.Context, userID int64, friendID int64) error {
	if _, err := u.userRepo.GetUserByID(ctx, userID); err != nil {
	...
	if _, err := u.userRepo.GetUserByID(ctx, friendID); err != nil {
