...
var userGRPCErrorMapper = newGRPCErrorMapper(
	[]error{
		...
		domain.ErrInvalidMovieReview,
		domain.ErrInvalidMovieComment,
		domain.ErrInvalidReviewID,
		domain.ErrInvalidReviewVote,
		domain.ErrMovieReviewNotFound,
		domain.ErrSelfReviewVote,
	...
	mergeGRPCErrorRules(commonGRPCErrorRules, map[error]grpcx.ErrResponse{
		...
		domain.ErrInvalidMovieReview:  {Code: codes.InvalidArgument, Message: "invalid movie review payload"},
		domain.ErrInvalidMovieComment: {Code: codes.InvalidArgument, Message: "invalid movie comment"},
		domain.ErrInvalidReviewID:     {Code: codes.InvalidArgument, Message: "invalid review id"},
		domain.ErrInvalidReviewVote:   {Code: codes.InvalidArgument, Message: "invalid review vote"},
		domain.ErrMovieReviewNotFound: {Code: codes.NotFound, Message: "movie review not found"},
		domain.ErrSelfReviewVote:      {Code: codes.FailedPrecondition, Message: "self review vote is forbidden"},
