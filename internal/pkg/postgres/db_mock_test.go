...
// Source: ./internal/pkg/postgres/interfaces.go
//
// Generated by this command:
//
//	mockgen -source=./internal/pkg/postgres/interfaces.go -destination=./internal/pkg/postgres/db_mock_test.go -package=postgres
//
...
func (m *MockPool) Query(ctx context.Context, sql string, args ...any) (Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockPool) QueryRow(ctx context.Context, sql string, args ...any) Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
