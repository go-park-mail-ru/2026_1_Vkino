...
import (
	...
	postgresx "github.com/go-park-mail-ru/2026_1_VKino/pkg/postgresx"
...
func (m *MockPool) Query(ctx context.Context, sql string, args ...any) (postgresx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockPool) QueryRow(ctx context.Context, sql string, args ...any) postgresx.Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
