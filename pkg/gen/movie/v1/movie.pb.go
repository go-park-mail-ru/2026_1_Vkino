...
var file_movie_v1_movie_proto_depIdxs = []int32{
	...
	27, // 10: movie.v1.GetContinueWatchingResponse.items:type_name -> movie.v1.WatchProgressItem
	27, // 11: movie.v1.GetWatchHistoryResponse.items:type_name -> movie.v1.WatchProgressItem
	0,  // 12: movie.v1.MovieService.GetMovieByID:input_type -> movie.v1.GetMovieByIDRequest
	4,  // 13: movie.v1.MovieService.GetMoviesByIDs:input_type -> movie.v1.GetMoviesByIDsRequest
	6,  // 14: movie.v1.MovieService.GetActorByID:input_type -> movie.v1.GetActorByIDRequest
	9,  // 15: movie.v1.MovieService.GetGenreByID:input_type -> movie.v1.GetGenreByIDRequest
	12, // 16: movie.v1.MovieService.GetAllGenres:input_type -> movie.v1.GetAllGenresRequest
	14, // 17: movie.v1.MovieService.GetSelectionByTitle:input_type -> movie.v1.GetSelectionByTitleRequest
	17, // 18: movie.v1.MovieService.GetAllSelections:input_type -> movie.v1.GetAllSelectionsRequest
	19, // 19: movie.v1.MovieService.SearchMovies:input_type -> movie.v1.SearchMoviesRequest
	21, // 20: movie.v1.MovieService.GetEpisodePlayback:input_type -> movie.v1.GetEpisodePlaybackRequest
	23, // 21: movie.v1.MovieService.GetEpisodeProgress:input_type -> movie.v1.GetEpisodeProgressRequest
	25, // 22: movie.v1.MovieService.SaveEpisodeProgress:input_type -> movie.v1.SaveEpisodeProgressRequest
	28, // 23: movie.v1.MovieService.GetContinueWatching:input_type -> movie.v1.GetContinueWatchingRequest
	30, // 24: movie.v1.MovieService.GetWatchHistory:input_type -> movie.v1.GetWatchHistoryRequest
	3,  // 25: movie.v1.MovieService.GetMovieByID:output_type -> movie.v1.GetMovieByIDResponse
	5,  // 26: movie.v1.MovieService.GetMoviesByIDs:output_type -> movie.v1.GetMoviesByIDsResponse
	8,  // 27: movie.v1.MovieService.GetActorByID:output_type -> movie.v1.GetActorByIDResponse
	10, // 28: movie.v1.MovieService.GetGenreByID:output_type -> movie.v1.GetGenreByIDResponse
	13, // 29: movie.v1.MovieService.GetAllGenres:output_type -> movie.v1.GetAllGenresResponse
	16, // 30: movie.v1.MovieService.GetSelectionByTitle:output_type -> movie.v1.GetSelectionByTitleResponse
	18, // 31: movie.v1.MovieService.GetAllSelections:output_type -> movie.v1.GetAllSelectionsResponse
	20, // 32: movie.v1.MovieService.SearchMovies:output_type -> movie.v1.SearchMoviesResponse
	22, // 33: movie.v1.MovieService.GetEpisodePlayback:output_type -> movie.v1.GetEpisodePlaybackResponse
	24, // 34: movie.v1.MovieService.GetEpisodeProgress:output_type -> movie.v1.GetEpisodeProgressResponse
	26, // 35: movie.v1.MovieService.SaveEpisodeProgress:output_type -> movie.v1.SaveEpisodeProgressResponse
	29, // 36: movie.v1.MovieService.GetContinueWatching:output_type -> movie.v1.GetContinueWatchingResponse
	31, // 37: movie.v1.MovieService.GetWatchHistory:output_type -> movie.v1.GetWatchHistoryResponse
