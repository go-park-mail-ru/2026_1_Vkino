...
const file_movie_v1_movie_proto_rawDesc = "" +
	...
	"\n" +
	"episode_id\x18\x01 \x01(\x03R\tepisodeId\x12)\n" +
	"\x10position_seconds\x18\x02 \x01(\x03R\x0fpositionSeconds2\xaf\x06\n" +
	"\fMovieService\x12M\n" +
...
var file_movie_v1_movie_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_movie_v1_movie_proto_goTypes = []any{
	...
	(*GetGenreByIDRequest)(nil),         // 7: movie.v1.GetGenreByIDRequest
	(*GetGenreByIDResponse)(nil),        // 8: movie.v1.GetGenreByIDResponse
...
var file_movie_v1_movie_proto_depIdxs = []int32{
	...
	5,  // 3: movie.v1.GetGenreByIDResponse.movies:type_name -> movie.v1.MovieCard
	5,  // 4: movie.v1.Selection.movies:type_name -> movie.v1.MovieCard
	5,  // 5: movie.v1.GetSelectionByTitleResponse.movies:type_name -> movie.v1.MovieCard
	10, // 6: movie.v1.GetAllSelectionsResponse.selections:type_name -> movie.v1.Selection
	5,  // 7: movie.v1.SearchMoviesResponse.movies:type_name -> movie.v1.MovieCard
	0,  // 8: movie.v1.MovieService.GetMovieByID:input_type -> movie.v1.GetMovieByIDRequest
	4,  // 9: movie.v1.MovieService.GetActorByID:input_type -> movie.v1.GetActorByIDRequest
	7,  // 10: movie.v1.MovieService.GetGenreByID:input_type -> movie.v1.GetGenreByIDRequest
	9,  // 11: movie.v1.MovieService.GetSelectionByTitle:input_type -> movie.v1.GetSelectionByTitleRequest
	12, // 12: movie.v1.MovieService.GetAllSelections:input_type -> movie.v1.GetAllSelectionsRequest
	14, // 13: movie.v1.MovieService.SearchMovies:input_type -> movie.v1.SearchMoviesRequest
	16, // 14: movie.v1.MovieService.GetEpisodePlayback:input_type -> movie.v1.GetEpisodePlaybackRequest
	18, // 15: movie.v1.MovieService.GetEpisodeProgress:input_type -> movie.v1.GetEpisodeProgressRequest
	20, // 16: movie.v1.MovieService.SaveEpisodeProgress:input_type -> movie.v1.SaveEpisodeProgressRequest
	3,  // 17: movie.v1.MovieService.GetMovieByID:output_type -> movie.v1.GetMovieByIDResponse
	6,  // 18: movie.v1.MovieService.GetActorByID:output_type -> movie.v1.GetActorByIDResponse
	8,  // 19: movie.v1.MovieService.GetGenreByID:output_type -> movie.v1.GetGenreByIDResponse
	11, // 20: movie.v1.MovieService.GetSelectionByTitle:output_type -> movie.v1.GetSelectionByTitleResponse
	13, // 21: movie.v1.MovieService.GetAllSelections:output_type -> movie.v1.GetAllSelectionsResponse
	15, // 22: movie.v1.MovieService.SearchMovies:output_type -> movie.v1.SearchMoviesResponse
	17, // 23: movie.v1.MovieService.GetEpisodePlayback:output_type -> movie.v1.GetEpisodePlaybackResponse
	19, // 24: movie.v1.MovieService.GetEpisodeProgress:output_type -> movie.v1.GetEpisodeProgressResponse
	21, // 25: movie.v1.MovieService.SaveEpisodeProgress:output_type -> movie.v1.SaveEpisodeProgressResponse
