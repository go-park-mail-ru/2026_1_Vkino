...
const (
	...
	PartyService_ResolveRoomPoll_FullMethodName    = "/party.v1.PartyService/ResolveRoomPoll"
...
type PartyServiceClient interface {
	...
	ResolveRoomPoll(ctx context.Context, in *ResolveRoomPollRequest, opts ...grpc.CallOption) (*ResolveRoomPollResponse, error)
...
func (c *partyServiceClient) ResolveRoomPoll(ctx context.Context, in *ResolveRoomPollRequest, opts ...grpc.CallOption) (*ResolveRoomPollResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveRoomPollResponse)
	err := c.cc.Invoke(ctx, PartyService_ResolveRoomPoll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PartyServiceServer interface {
	...
	ResolveRoomPoll(context.Context, *ResolveRoomPollRequest) (*ResolveRoomPollResponse, error)
...
func (UnimplementedPartyServiceServer) ResolveRoomPoll(context.Context, *ResolveRoomPollRequest) (*ResolveRoomPollResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveRoomPoll not implemented")
}
...
func _PartyService_ResolveRoomPoll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveRoomPollRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PartyServiceServer).ResolveRoomPoll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PartyService_ResolveRoomPoll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PartyServiceServer).ResolveRoomPoll(ctx, req.(*ResolveRoomPollRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PartyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveRoomPoll",
			Handler:    _PartyService_ResolveRoomPoll_Handler,
		},
	},
