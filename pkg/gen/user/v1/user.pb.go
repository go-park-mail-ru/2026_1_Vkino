...
var file_user_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_user_v1_user_proto_goTypes = []any{
	...
	(*SearchUsersByEmailRequest)(nil),           // 16: user.v1.SearchUsersByEmailRequest
	(*UserSearchResult)(nil),                    // 17: user.v1.UserSearchResult
	(*SearchUsersByEmailResponse)(nil),          // 18: user.v1.SearchUsersByEmailResponse
	(*AddFriendRequest)(nil),                    // 19: user.v1.AddFriendRequest
	(*AddFriendResponse)(nil),                   // 20: user.v1.AddFriendResponse
	(*DeleteFriendRequest)(nil),                 // 21: user.v1.DeleteFriendRequest
	(*DeleteFriendResponse)(nil),                // 22: user.v1.DeleteFriendResponse
	(*AddMovieToFavoritesRequest)(nil),          // 23: user.v1.AddMovieToFavoritesRequest
	(*AddMovieToFavoritesResponse)(nil),         // 24: user.v1.AddMovieToFavoritesResponse
	(*SetMovieRatingRequest)(nil),               // 25: user.v1.SetMovieRatingRequest
	(*SetMovieRatingResponse)(nil),              // 26: user.v1.SetMovieRatingResponse
	(*SetMovieReviewRequest)(nil),               // 27: user.v1.SetMovieReviewRequest
	(*SetMovieReviewResponse)(nil),              // 28: user.v1.SetMovieReviewResponse
	(*DeleteMovieReviewRequest)(nil),            // 29: user.v1.DeleteMovieReviewRequest
	(*DeleteMovieReviewResponse)(nil),           // 30: user.v1.DeleteMovieReviewResponse
	(*SetReviewReactionRequest)(nil),            // 31: user.v1.SetReviewReactionRequest
	(*SetReviewReactionResponse)(nil),           // 32: user.v1.SetReviewReactionResponse
	(*DeleteReviewReactionRequest)(nil),         // 33: user.v1.DeleteReviewReactionRequest
	(*DeleteReviewReactionResponse)(nil),        // 34: user.v1.DeleteReviewReactionResponse
	(*ToggleFavoriteRequest)(nil),               // 35: user.v1.ToggleFavoriteRequest
	(*ToggleFavoriteResponse)(nil),              // 36: user.v1.ToggleFavoriteResponse
	(*GetFavoritesRequest)(nil),                 // 37: user.v1.GetFavoritesRequest
	(*GetFavoritesResponse)(nil),                // 38: user.v1.GetFavoritesResponse
	(*SearchUsersRequest)(nil),                  // 39: user.v1.SearchUsersRequest
	(*SearchUsersResponse)(nil),                 // 40: user.v1.SearchUsersResponse
	(*SendFriendRequestRequest)(nil),            // 41: user.v1.SendFriendRequestRequest
	(*SendFriendRequestResponse)(nil),           // 42: user.v1.SendFriendRequestResponse
	(*RespondToFriendRequestRequest)(nil),       // 43: user.v1.RespondToFriendRequestRequest
	(*RespondToFriendRequestResponse)(nil),      // 44: user.v1.RespondToFriendRequestResponse
	(*DeleteOutgoingFriendRequestRequest)(nil),  // 45: user.v1.DeleteOutgoingFriendRequestRequest
	(*DeleteOutgoingFriendRequestResponse)(nil), // 46: user.v1.DeleteOutgoingFriendRequestResponse
	(*GetFriendRequestsRequest)(nil),            // 47: user.v1.GetFriendRequestsRequest
	(*FriendRequestItem)(nil),                   // 48: user.v1.FriendRequestItem
	(*GetFriendRequestsResponse)(nil),           // 49: user.v1.GetFriendRequestsResponse
	(*GetFriendsListRequest)(nil),               // 50: user.v1.GetFriendsListRequest
	(*GetFriendsListResponse)(nil),              // 51: user.v1.GetFriendsListResponse
}
var file_user_v1_user_proto_depIdxs = []int32{
	...
	17, // 5: user.v1.SearchUsersByEmailResponse.users:type_name -> user.v1.UserSearchResult
	17, // 6: user.v1.SearchUsersResponse.users:type_name -> user.v1.UserSearchResult
	48, // 7: user.v1.GetFriendRequestsResponse.requests:type_name -> user.v1.FriendRequestItem
	17, // 8: user.v1.GetFriendsListResponse.friends:type_name -> user.v1.UserSearchResult
	0,  // 9: user.v1.UserService.GetProfile:input_type -> user.v1.GetProfileRequest
	2,  // 10: user.v1.UserService.GetFriend:input_type -> user.v1.GetFriendRequest
	4,  // 11: user.v1.UserService.GetSubscriptionCapabilities:input_type -> user.v1.GetSubscriptionCapabilitiesRequest
	9,  // 12: user.v1.UserService.GetVKinoCoinsHistory:input_type -> user.v1.GetVKinoCoinsHistoryRequest
	12, // 13: user.v1.UserService.ActivateSubscription:input_type -> user.v1.ActivateSubscriptionRequest
	14, // 14: user.v1.UserService.UpdateProfile:input_type -> user.v1.UpdateProfileRequest
	16, // 15: user.v1.UserService.SearchUsersByEmail:input_type -> user.v1.SearchUsersByEmailRequest
	19, // 16: user.v1.UserService.AddFriend:input_type -> user.v1.AddFriendRequest
	21, // 17: user.v1.UserService.DeleteFriend:input_type -> user.v1.DeleteFriendRequest
	23, // 18: user.v1.UserService.AddMovieToFavorites:input_type -> user.v1.AddMovieToFavoritesRequest
	25, // 19: user.v1.UserService.SetMovieRating:input_type -> user.v1.SetMovieRatingRequest
	27, // 20: user.v1.UserService.SetMovieReview:input_type -> user.v1.SetMovieReviewRequest
	29, // 21: user.v1.UserService.DeleteMovieReview:input_type -> user.v1.DeleteMovieReviewRequest
	31, // 22: user.v1.UserService.SetReviewReaction:input_type -> user.v1.SetReviewReactionRequest
	33, // 23: user.v1.UserService.DeleteReviewReaction:input_type -> user.v1.DeleteReviewReactionRequest
	35, // 24: user.v1.UserService.ToggleFavorite:input_type -> user.v1.ToggleFavoriteRequest
	37, // 25: user.v1.UserService.GetFavorites:input_type -> user.v1.GetFavoritesRequest
	39, // 26: user.v1.UserService.SearchUsers:input_type -> user.v1.SearchUsersRequest
	41, // 27: user.v1.UserService.SendFriendRequest:input_type -> user.v1.SendFriendRequestRequest
	43, // 28: user.v1.UserService.RespondToFriendRequest:input_type -> user.v1.RespondToFriendRequestRequest
	45, // 29: user.v1.UserService.DeleteOutgoingFriendRequest:input_type -> user.v1.DeleteOutgoingFriendRequestRequest
	47, // 30: user.v1.UserService.GetFriendRequests:input_type -> user.v1.GetFriendRequestsRequest
	50, // 31: user.v1.UserService.GetFriendsList:input_type -> user.v1.GetFriendsListRequest
	1,  // 32: user.v1.UserService.GetProfile:output_type -> user.v1.GetProfileResponse
	3,  // 33: user.v1.UserService.GetFriend:output_type -> user.v1.GetFriendResponse
	8,  // 34: user.v1.UserService.GetSubscriptionCapabilities:output_type -> user.v1.GetSubscriptionCapabilitiesResponse
	11, // 35: user.v1.UserService.GetVKinoCoinsHistory:output_type -> user.v1.GetVKinoCoinsHistoryResponse
	13, // 36: user.v1.UserService.ActivateSubscription:output_type -> user.v1.ActivateSubscriptionResponse
	15, // 37: user.v1.UserService.UpdateProfile:output_type -> user.v1.UpdateProfileResponse
	18, // 38: user.v1.UserService.SearchUsersByEmail:output_type -> user.v1.SearchUsersByEmailResponse
	20, // 39: user.v1.UserService.AddFriend:output_type -> user.v1.AddFriendResponse
	22, // 40: user.v1.UserService.DeleteFriend:output_type -> user.v1.DeleteFriendResponse
	24, // 41: user.v1.UserService.AddMovieToFavorites:output_type -> user.v1.AddMovieToFavoritesResponse
	26, // 42: user.v1.UserService.SetMovieRating:output_type -> user.v1.SetMovieRatingResponse
	28, // 43: user.v1.UserService.SetMovieReview:output_type -> user.v1.SetMovieReviewResponse
	30, // 44: user.v1.UserService.DeleteMovieReview:output_type -> user.v1.DeleteMovieReviewResponse
	32, // 45: user.v1.UserService.SetReviewReaction:output_type -> user.v1.SetReviewReactionResponse
	34, // 46: user.v1.UserService.DeleteReviewReaction:output_type -> user.v1.DeleteReviewReactionResponse
	36, // 47: user.v1.UserService.ToggleFavorite:output_type -> user.v1.ToggleFavoriteResponse
	38, // 48: user.v1.UserService.GetFavorites:output_type -> user.v1.GetFavoritesResponse
	40, // 49: user.v1.UserService.SearchUsers:output_type -> user.v1.SearchUsersResponse
	42, // 50: user.v1.UserService.SendFriendRequest:output_type -> user.v1.SendFriendRequestResponse
	44, // 51: user.v1.UserService.RespondToFriendRequest:output_type -> user.v1.RespondToFriendRequestResponse
	46, // 52: user.v1.UserService.DeleteOutgoingFriendRequest:output_type -> user.v1.DeleteOutgoingFriendRequestResponse
	49, // 53: user.v1.UserService.GetFriendRequests:output_type -> user.v1.GetFriendRequestsResponse
	51, // 54: user.v1.UserService.GetFriendsList:output_type -> user.v1.GetFriendsListResponse
...
func file_user_v1_user_proto_init() {
	...
	file_user_v1_user_proto_msgTypes[28].OneofWrappers = []any{}
	type x struct{}
