...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\tGetFriend\x12\x19.user.v1.GetFriendRequest\x1a\x1a.user.v1.GetFriendResponse\x12N\n" +
...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*SearchUsersByEmailRequest)(nil),           // 6: user.v1.SearchUsersByEmailRequest
	(*UserSearchResult)(nil),                    // 7: user.v1.UserSearchResult
	(*SearchUsersByEmailResponse)(nil),          // 8: user.v1.SearchUsersByEmailResponse
	(*AddFriendRequest)(nil),                    // 9: user.v1.AddFriendRequest
	(*AddFriendResponse)(nil),                   // 10: user.v1.AddFriendResponse
	(*DeleteFriendRequest)(nil),                 // 11: user.v1.DeleteFriendRequest
	(*DeleteFriendResponse)(nil),                // 12: user.v1.DeleteFriendResponse
	(*AddMovieToFavoritesRequest)(nil),          // 13: user.v1.AddMovieToFavoritesRequest
	(*AddMovieToFavoritesResponse)(nil),         // 14: user.v1.AddMovieToFavoritesResponse
	(*SetMovieRatingRequest)(nil),               // 15: user.v1.SetMovieRatingRequest
	(*SetMovieRatingResponse)(nil),              // 16: user.v1.SetMovieRatingResponse
	(*SetMovieReviewRequest)(nil),               // 17: user.v1.SetMovieReviewRequest
	(*SetMovieReviewResponse)(nil),              // 18: user.v1.SetMovieReviewResponse
	(*DeleteMovieReviewRequest)(nil),            // 19: user.v1.DeleteMovieReviewRequest
	(*DeleteMovieReviewResponse)(nil),           // 20: user.v1.DeleteMovieReviewResponse
	(*SetReviewReactionRequest)(nil),            // 21: user.v1.SetReviewReactionRequest
	(*SetReviewReactionResponse)(nil),           // 22: user.v1.SetReviewReactionResponse
	(*DeleteReviewReactionRequest)(nil),         // 23: user.v1.DeleteReviewReactionRequest
	(*DeleteReviewReactionResponse)(nil),        // 24: user.v1.DeleteReviewReactionResponse
	(*ToggleFavoriteRequest)(nil),               // 25: user.v1.ToggleFavoriteRequest
	(*ToggleFavoriteResponse)(nil),              // 26: user.v1.ToggleFavoriteResponse
	(*GetFavoritesRequest)(nil),                 // 27: user.v1.GetFavoritesRequest
	(*GetFavoritesResponse)(nil),                // 28: user.v1.GetFavoritesResponse
	(*SearchUsersRequest)(nil),                  // 29: user.v1.SearchUsersRequest
	(*SearchUsersResponse)(nil),                 // 30: user.v1.SearchUsersResponse
	(*SendFriendRequestRequest)(nil),            // 31: user.v1.SendFriendRequestRequest
	(*SendFriendRequestResponse)(nil),           // 32: user.v1.SendFriendRequestResponse
	(*RespondToFriendRequestRequest)(nil),       // 33: user.v1.RespondToFriendRequestRequest
	(*RespondToFriendRequestResponse)(nil),      // 34: user.v1.RespondToFriendRequestResponse
	(*DeleteOutgoingFriendRequestRequest)(nil),  // 35: user.v1.DeleteOutgoingFriendRequestRequest
	(*DeleteOutgoingFriendRequestResponse)(nil), // 36: user.v1.DeleteOutgoingFriendRequestResponse
	(*GetFriendRequestsRequest)(nil),            // 37: user.v1.GetFriendRequestsRequest
	(*FriendRequestItem)(nil),                   // 38: user.v1.FriendRequestItem
	(*GetFriendRequestsResponse)(nil),           // 39: user.v1.GetFriendRequestsResponse
	(*GetFriendsListRequest)(nil),               // 40: user.v1.GetFriendsListRequest
	(*GetFriendsListResponse)(nil),              // 41: user.v1.GetFriendsListResponse
}
var file_user_v1_user_proto_depIdxs = []int32{
	7,  // 0: user.v1.SearchUsersByEmailResponse.users:type_name -> user.v1.UserSearchResult
	7,  // 1: user.v1.SearchUsersResponse.users:type_name -> user.v1.UserSearchResult
	38, // 2: user.v1.GetFriendRequestsResponse.requests:type_name -> user.v1.FriendRequestItem
	7,  // 3: user.v1.GetFriendsListResponse.friends:type_name -> user.v1.UserSearchResult
	0,  // 4: user.v1.UserService.GetProfile:input_type -> user.v1.GetProfileRequest
	2,  // 5: user.v1.UserService.GetFriend:input_type -> user.v1.GetFriendRequest
	4,  // 6: user.v1.UserService.UpdateProfile:input_type -> user.v1.UpdateProfileRequest
	6,  // 7: user.v1.UserService.SearchUsersByEmail:input_type -> user.v1.SearchUsersByEmailRequest
	9,  // 8: user.v1.UserService.AddFriend:input_type -> user.v1.AddFriendRequest
	11, // 9: user.v1.UserService.DeleteFriend:input_type -> user.v1.DeleteFriendRequest
	13, // 10: user.v1.UserService.AddMovieToFavorites:input_type -> user.v1.AddMovieToFavoritesRequest
	15, // 11: user.v1.UserService.SetMovieRating:input_type -> user.v1.SetMovieRatingRequest
	17, // 12: user.v1.UserService.SetMovieReview:input_type -> user.v1.SetMovieReviewRequest
	19, // 13: user.v1.UserService.DeleteMovieReview:input_type -> user.v1.DeleteMovieReviewRequest
	21, // 14: user.v1.UserService.SetReviewReaction:input_type -> user.v1.SetReviewReactionRequest
	23, // 15: user.v1.UserService.DeleteReviewReaction:input_type -> user.v1.DeleteReviewReactionRequest
	25, // 16: user.v1.UserService.ToggleFavorite:input_type -> user.v1.ToggleFavoriteRequest
	27, // 17: user.v1.UserService.GetFavorites:input_type -> user.v1.GetFavoritesRequest
	29, // 18: user.v1.UserService.SearchUsers:input_type -> user.v1.SearchUsersRequest
	31, // 19: user.v1.UserService.SendFriendRequest:input_type -> user.v1.SendFriendRequestRequest
	33, // 20: user.v1.UserService.RespondToFriendRequest:input_type -> user.v1.RespondToFriendRequestRequest
	35, // 21: user.v1.UserService.DeleteOutgoingFriendRequest:input_type -> user.v1.DeleteOutgoingFriendRequestRequest
	37, // 22: user.v1.UserService.GetFriendRequests:input_type -> user.v1.GetFriendRequestsRequest
	40, // 23: user.v1.UserService.GetFriendsList:input_type -> user.v1.GetFriendsListRequest
	1,  // 24: user.v1.UserService.GetProfile:output_type -> user.v1.GetProfileResponse
	3,  // 25: user.v1.UserService.GetFriend:output_type -> user.v1.GetFriendResponse
	5,  // 26: user.v1.UserService.UpdateProfile:output_type -> user.v1.UpdateProfileResponse
	8,  // 27: user.v1.UserService.SearchUsersByEmail:output_type -> user.v1.SearchUsersByEmailResponse
	10, // 28: user.v1.UserService.AddFriend:output_type -> user.v1.AddFriendResponse
	12, // 29: user.v1.UserService.DeleteFriend:output_type -> user.v1.DeleteFriendResponse
	14, // 30: user.v1.UserService.AddMovieToFavorites:output_type -> user.v1.AddMovieToFavoritesResponse
	16, // 31: user.v1.UserService.SetMovieRating:output_type -> user.v1.SetMovieRatingResponse
	18, // 32: user.v1.UserService.SetMovieReview:output_type -> user.v1.SetMovieReviewResponse
	20, // 33: user.v1.UserService.DeleteMovieReview:output_type -> user.v1.DeleteMovieReviewResponse
	22, // 34: user.v1.UserService.SetReviewReaction:output_type -> user.v1.SetReviewReactionResponse
	24, // 35: user.v1.UserService.DeleteReviewReaction:output_type -> user.v1.DeleteReviewReactionResponse
	26, // 36: user.v1.UserService.ToggleFavorite:output_type -> user.v1.ToggleFavoriteResponse
	28, // 37: user.v1.UserService.GetFavorites:output_type -> user.v1.GetFavoritesResponse
	30, // 38: user.v1.UserService.SearchUsers:output_type -> user.v1.SearchUsersResponse
	32, // 39: user.v1.UserService.SendFriendRequest:output_type -> user.v1.SendFriendRequestResponse
	34, // 40: user.v1.UserService.RespondToFriendRequest:output_type -> user.v1.RespondToFriendRequestResponse
	36, // 41: user.v1.UserService.DeleteOutgoingFriendRequest:output_type -> user.v1.DeleteOutgoingFriendRequestResponse
	39, // 42: user.v1.UserService.GetFriendRequests:output_type -> user.v1.GetFriendRequestsResponse
	41, // 43: user.v1.UserService.GetFriendsList:output_type -> user.v1.GetFriendsListResponse
