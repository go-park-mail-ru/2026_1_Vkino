...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\fsubscription\x18\x04 \x01(\v2\x19.user.v1.SubscriptionInfoR\fsubscription\"\x95\x01\n" +
	...
	"\x1dBuySubscriptionWithVKinoCoins\x12-.user.v1.BuySubscriptionWithVKinoCoinsRequest\x1a..user.v1.BuySubscriptionWithVKinoCoinsResponse\x12N\n" +
...
var file_user_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_user_v1_user_proto_goTypes = []any{
	...
	(*SearchUsersByEmailRequest)(nil),             // 18: user.v1.SearchUsersByEmailRequest
	(*UserSearchResult)(nil),                      // 19: user.v1.UserSearchResult
	(*SearchUsersByEmailResponse)(nil),            // 20: user.v1.SearchUsersByEmailResponse
	(*AddFriendRequest)(nil),                      // 21: user.v1.AddFriendRequest
	(*AddFriendResponse)(nil),                     // 22: user.v1.AddFriendResponse
	(*DeleteFriendRequest)(nil),                   // 23: user.v1.DeleteFriendRequest
	(*DeleteFriendResponse)(nil),                  // 24: user.v1.DeleteFriendResponse
	(*AddMovieToFavoritesRequest)(nil),            // 25: user.v1.AddMovieToFavoritesRequest
	(*AddMovieToFavoritesResponse)(nil),           // 26: user.v1.AddMovieToFavoritesResponse
	(*SetMovieRatingRequest)(nil),                 // 27: user.v1.SetMovieRatingRequest
	(*SetMovieRatingResponse)(nil),                // 28: user.v1.SetMovieRatingResponse
	(*SetMovieReviewRequest)(nil),                 // 29: user.v1.SetMovieReviewRequest
	(*SetMovieReviewResponse)(nil),                // 30: user.v1.SetMovieReviewResponse
	(*DeleteMovieReviewRequest)(nil),              // 31: user.v1.DeleteMovieReviewRequest
	(*DeleteMovieReviewResponse)(nil),             // 32: user.v1.DeleteMovieReviewResponse
	(*SetReviewReactionRequest)(nil),              // 33: user.v1.SetReviewReactionRequest
	(*SetReviewReactionResponse)(nil),             // 34: user.v1.SetReviewReactionResponse
	(*DeleteReviewReactionRequest)(nil),           // 35: user.v1.DeleteReviewReactionRequest
	(*DeleteReviewReactionResponse)(nil),          // 36: user.v1.DeleteReviewReactionResponse
	(*ToggleFavoriteRequest)(nil),                 // 37: user.v1.ToggleFavoriteRequest
	(*ToggleFavoriteResponse)(nil),                // 38: user.v1.ToggleFavoriteResponse
	(*GetFavoritesRequest)(nil),                   // 39: user.v1.GetFavoritesRequest
	(*GetFavoritesResponse)(nil),                  // 40: user.v1.GetFavoritesResponse
	(*SearchUsersRequest)(nil),                    // 41: user.v1.SearchUsersRequest
	(*SearchUsersResponse)(nil),                   // 42: user.v1.SearchUsersResponse
	(*SendFriendRequestRequest)(nil),              // 43: user.v1.SendFriendRequestRequest
	(*SendFriendRequestResponse)(nil),             // 44: user.v1.SendFriendRequestResponse
	(*RespondToFriendRequestRequest)(nil),         // 45: user.v1.RespondToFriendRequestRequest
	(*RespondToFriendRequestResponse)(nil),        // 46: user.v1.RespondToFriendRequestResponse
	(*DeleteOutgoingFriendRequestRequest)(nil),    // 47: user.v1.DeleteOutgoingFriendRequestRequest
	(*DeleteOutgoingFriendRequestResponse)(nil),   // 48: user.v1.DeleteOutgoingFriendRequestResponse
	(*GetFriendRequestsRequest)(nil),              // 49: user.v1.GetFriendRequestsRequest
	(*FriendRequestItem)(nil),                     // 50: user.v1.FriendRequestItem
	(*GetFriendRequestsResponse)(nil),             // 51: user.v1.GetFriendRequestsResponse
	(*GetFriendsListRequest)(nil),                 // 52: user.v1.GetFriendsListRequest
	(*GetFriendsListResponse)(nil),                // 53: user.v1.GetFriendsListResponse
}
var file_user_v1_user_proto_depIdxs = []int32{
	...
	19, // 6: user.v1.SearchUsersByEmailResponse.users:type_name -> user.v1.UserSearchResult
	19, // 7: user.v1.SearchUsersResponse.users:type_name -> user.v1.UserSearchResult
	50, // 8: user.v1.GetFriendRequestsResponse.requests:type_name -> user.v1.FriendRequestItem
	19, // 9: user.v1.GetFriendsListResponse.friends:type_name -> user.v1.UserSearchResult
	...
	16, // 16: user.v1.UserService.UpdateProfile:input_type -> user.v1.UpdateProfileRequest
	18, // 17: user.v1.UserService.SearchUsersByEmail:input_type -> user.v1.SearchUsersByEmailRequest
	21, // 18: user.v1.UserService.AddFriend:input_type -> user.v1.AddFriendRequest
	23, // 19: user.v1.UserService.DeleteFriend:input_type -> user.v1.DeleteFriendRequest
	25, // 20: user.v1.UserService.AddMovieToFavorites:input_type -> user.v1.AddMovieToFavoritesRequest
	27, // 21: user.v1.UserService.SetMovieRating:input_type -> user.v1.SetMovieRatingRequest
	29, // 22: user.v1.UserService.SetMovieReview:input_type -> user.v1.SetMovieReviewRequest
	31, // 23: user.v1.UserService.DeleteMovieReview:input_type -> user.v1.DeleteMovieReviewRequest
	33, // 24: user.v1.UserService.SetReviewReaction:input_type -> user.v1.SetReviewReactionRequest
	35, // 25: user.v1.UserService.DeleteReviewReaction:input_type -> user.v1.DeleteReviewReactionRequest
	37, // 26: user.v1.UserService.ToggleFavorite:input_type -> user.v1.ToggleFavoriteRequest
	39, // 27: user.v1.UserService.GetFavorites:input_type -> user.v1.GetFavoritesRequest
	41, // 28: user.v1.UserService.SearchUsers:input_type -> user.v1.SearchUsersRequest
	43, // 29: user.v1.UserService.SendFriendRequest:input_type -> user.v1.SendFriendRequestRequest
	45, // 30: user.v1.UserService.RespondToFriendRequest:input_type -> user.v1.RespondToFriendRequestRequest
	47, // 31: user.v1.UserService.DeleteOutgoingFriendRequest:input_type -> user.v1.DeleteOutgoingFriendRequestRequest
	49, // 32: user.v1.UserService.GetFriendRequests:input_type -> user.v1.GetFriendRequestsRequest
	52, // 33: user.v1.UserService.GetFriendsList:input_type -> user.v1.GetFriendsListRequest
	1,  // 34: user.v1.UserService.GetProfile:output_type -> user.v1.GetProfileResponse
	3,  // 35: user.v1.UserService.GetFriend:output_type -> user.v1.GetFriendResponse
	8,  // 36: user.v1.UserService.GetSubscriptionCapabilities:output_type -> user.v1.GetSubscriptionCapabilitiesResponse
	11, // 37: user.v1.UserService.GetVKinoCoinsHistory:output_type -> user.v1.GetVKinoCoinsHistoryResponse
	13, // 38: user.v1.UserService.ActivateSubscription:output_type -> user.v1.ActivateSubscriptionResponse
	15, // 39: user.v1.UserService.BuySubscriptionWithVKinoCoins:output_type -> user.v1.BuySubscriptionWithVKinoCoinsResponse
	17, // 40: user.v1.UserService.UpdateProfile:output_type -> user.v1.UpdateProfileResponse
	20, // 41: user.v1.UserService.SearchUsersByEmail:output_type -> user.v1.SearchUsersByEmailResponse
	22, // 42: user.v1.UserService.AddFriend:output_type -> user.v1.AddFriendResponse
	24, // 43: user.v1.UserService.DeleteFriend:output_type -> user.v1.DeleteFriendResponse
	26, // 44: user.v1.UserService.AddMovieToFavorites:output_type -> user.v1.AddMovieToFavoritesResponse
	28, // 45: user.v1.UserService.SetMovieRating:output_type -> user.v1.SetMovieRatingResponse
	30, // 46: user.v1.UserService.SetMovieReview:output_type -> user.v1.SetMovieReviewResponse
	32, // 47: user.v1.UserService.DeleteMovieReview:output_type -> user.v1.DeleteMovieReviewResponse
	34, // 48: user.v1.UserService.SetReviewReaction:output_type -> user.v1.SetReviewReactionResponse
	36, // 49: user.v1.UserService.DeleteReviewReaction:output_type -> user.v1.DeleteReviewReactionResponse
	38, // 50: user.v1.UserService.ToggleFavorite:output_type -> user.v1.ToggleFavoriteResponse
	40, // 51: user.v1.UserService.GetFavorites:output_type -> user.v1.GetFavoritesResponse
	42, // 52: user.v1.UserService.SearchUsers:output_type -> user.v1.SearchUsersResponse
	44, // 53: user.v1.UserService.SendFriendRequest:output_type -> user.v1.SendFriendRequestResponse
	46, // 54: user.v1.UserService.RespondToFriendRequest:output_type -> user.v1.RespondToFriendRequestResponse
	48, // 55: user.v1.UserService.DeleteOutgoingFriendRequest:output_type -> user.v1.DeleteOutgoingFriendRequestResponse
	51, // 56: user.v1.UserService.GetFriendRequests:output_type -> user.v1.GetFriendRequestsResponse
	53, // 57: user.v1.UserService.GetFriendsList:output_type -> user.v1.GetFriendsListResponse
